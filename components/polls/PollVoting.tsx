...
// app/(public)/components/polls/PollVoting.tsx
// 'use client';
...
// export default function PollVoting({ pollId, options, totalVotes, isActive, pollType = 'FREE' }: PollVotingProps) {
...
//     // Simulate vote - replace with actual API call
//     setTimeout(() => {
//       setHasVoted(true);
...
//           <div className="flex items-center justify-center gap-2 text-green-600 bg-green-50 p-4 rounded-xl mt-6">
//             <CheckCircle className="w-5 h-5" />
//             <span className="font-medium">Thank you for voting!</span>
//           </div>
//         </div>
